...
class convention (models.Model):
    id_convention = models.CharField(max_length=5,primary_key=True)
...
class promoteur (models.Model):
    id_promoteur=models.CharField(primary_key=True,max_length=5)
...
class encadreur (models.Model):
    id_encadreur=models.CharField(primary_key=True,max_length=5)
...
class ficheSuivi (models.Model):
    id_ficheSuivi = models.CharField(max_length=5,primary_key=True)
...
class ficheEvaluation (models.Model):
    id_ficheEvaluation = models.CharField(max_length=5,primary_key=True)
...
class soutenance(models.Model):
    id_soutenance= models.CharField(max_length=5,primary_key=True)
