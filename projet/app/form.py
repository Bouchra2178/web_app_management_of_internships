...
class stageForm(ModelForm):
    class Meta:
        ...
        fields='__all__'
        widgets={ 
       'code':forms.TextInput(attrs={'class':'form-control ClassName','placeholder':'st001'}),
...
class stagiaireForm(ModelForm):
    class Meta:
        ...
        fields=('matricule','nom','prenom','specialite','section','annee',)
        widgets={
            'matricule':forms.TextInput(attrs={'class':'form-control ','size':12}),
